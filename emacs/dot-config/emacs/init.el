...
(use-package emacs
  ...
  (tab-width 2)
  (sgml-basic-offset 2) ;; Set Html mode indentation to 4
  (c-ts-mode-indent-offset 2) ;; Fix weird indentation in c-ts (C, C++)
  (go-ts-mode-indent-offset 2) ;; Fix weird indentation in go-ts
...
(use-package general
  ...
  (general-define-key
   :keymaps 'override
   "M-o" '(other-window :wk "Other window"))

  (general-define-key
   :keymaps 'override
   "C-," '(brian/duplicate-line :wk "Duplicate line"))

  (general-create-definer brian/prefixmap
    :keymaps 'override
    :prefix "C-q"
    :global-prefix "C-q")

  (brian/prefixmap
    "s" '(consult-line :wk "Consult line")
    "C-s" '(consult-line :wk "Consult line")
    "l" '(brian/highlight-line :wk "Highlight line")
    "C-l" '(brian/highlight-line :wk "Highlight line")
    "w" '(brian/select-word :wk "Highlight word")
    "C-w" '(brian/select-word :wk "Highlight word")
    "k" '(brian/kill-line :wk "Kill line")
    "C-k" '(brian/kill-line :wk "Kill line")
    "j" '(avy-goto-char :wk "Goto character")
    "C-j" '(avy-goto-char :wk "Goto character"))
  ...
  (general-create-definer start/leader-keys
    ...
    :keymaps 'override
    :prefix "C-c SPC"
    :global-prefix "C-c SPC") ;; Set global leader key so we can access our keybindings from any state
  ...
  (start/leader-keys
    ...
    "f g" '(consult-ripgrep :wk "Find with ripgrep")
    "f l" '(consult-line :wk "Find line")
    "f i" '(consult-imenu :wk "Find in Imenu buffer locations")) ;; This one is really cool
