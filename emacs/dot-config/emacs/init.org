...
** Advice
The next bit is a nice trick to recenter the screen after scrolling
#+begin_src emacs-lisp
...
This theme is something that Brian prefers a lot more.
#+begin_src emacs-lisp
...
#+end_src
** Markdown
Need markdown mode I think for better hover support
#+begin_src emacs-lisp
...
Quality of life plugin for rocq (displays nice forall etc)
...
Since company coq uses company (shocking...) we have to disable corfu
just for this.
...
We use AUCTeX for editing, compiling, and navigating TeX files.
...
RefTeX improves labels, references, citations, and table-of-contents navigation.
...
This lets Emacs preview PDFs directly.
...
#+end_src
** Org Roam
Using org roam to organise knowledge and general notetaking
#+begin_src emacs-lisp
...
* Teaching
** Typst
Here I have to install `typst-ts-mode' to be able to make slides
#+begin_src emacs-lisp
